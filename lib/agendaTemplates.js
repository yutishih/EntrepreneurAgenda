...
export const CHINA_DEFAULT_ROWS = [
  ...
  { time: '7:22', duration: '10', program: 'Variety Session', assignee: '', assigneeNext: '' },
  { time: '7:33', duration: '1', program: 'Manual Speech', assignee: '', assigneeNext: '', section: true },
  { time: '7:35', duration: "5-7", program: 'PM L2P1: ', assignee: '', assigneeNext: '', section: true },
...
<div class="china-header">
  <div class="china-logo">${logoHtml}</div>
  <div class="china-titles">
    <div class="china-title-main">CHANGE <span class="china-title-accent">IN</span> ACTION</div>
...
<div class="china-meetingbar">
  ...
  <div>Date(Y/M/D): <strong>${dateDisplay}</strong></div>
</div>
...
<div class="china-qrrow">
  <div class="china-qr-item">${qrImg(img.evoting, 'E-Voting')}<div class="china-qr-lbl">E-Voting</div></div>
  <div class="china-qr-item">${qrImg(img.membership, 'Membership Registration')}<div class="china-qr-lbl">Membership Registration</div></div>
  <div class="china-join"><strong>Join Us NOW!</strong><br>Talk to club officers for member benefits!</div>
</div>
`;
...
<table class="china-officer-table">
  <thead><tr><th></th><th>Lead</th><th>Deputy</th></tr></thead>
...
<div class="china-recap">
  ...
  <div class="china-recap-stats">
    <div>Attend Members: <strong>${esc(pm.attendMembers)}</strong></div>
    <div>Attend Guests: <strong>${esc(pm.attendGuests)}</strong></div>
...
${officerTable ? `<div class="china-section-title">Officer Team</div>${officerTable}` : ''}

<div class="china-footer-brand">CHANGE IN ACTION</div>

<div class="china-connect">
  <div>Connect with us online! &nbsp; Email: ${esc(contactEmail)}</div>
